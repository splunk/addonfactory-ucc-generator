...
| globalConfig.json | output/&lt;YOUR_ADDON_NAME&gt;/appserver/static/js/builds | Generates minimal globalConfig.json file in source code if globalConfig is not present in source directory.|
