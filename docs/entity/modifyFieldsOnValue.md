...
| --------------------------------------------------- | ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| fieldValue<span class="required-asterisk">\*</span> | string \| <br> `{`<br>`pattern: string`<br>`}` | The value of the current field that will trigger the modification. Use `[[any_other_value]]` to apply modifications for any value other than those explicitly specified.Alternatively, you can provide an object with a `pattern` property to validate the value against a regular expression. |
