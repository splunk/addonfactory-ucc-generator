...
- `options`:
    ...
    - Fields allowed in basic and oauth fields as of now:
        ...
        - `placeholder`: The placeholder for the field. <br> <span style="background-color: #708794">The "placeholder" attribute is no longer supported. Instead, we insist using the "help" attribute.</span>
