...
class Range(Validator):
    ...
    def __init__(self, minVal=None, maxVal=None):
        ...
        """
        assert ((minVal is None or isinstance(minVal, (int, long, float))) and
                (maxVal is None or isinstance(maxVal, (int, long, float)))), \
...
class String(Validator):
    ...
    def __init__(self, minLen=None, maxLen=None):
        ...
        """
        assert ((minLen is None or isinstance(minLen, (int, long, float))) and
                (maxLen is None or isinstance(maxLen, (int, long, float)))), \
