...
//                 if (collection._url.indexOf("ta_tenable_nessus_inputs") > -1 && "nessus".indexOf(rawSearch) > -1 ||
//                         collection._url.indexOf("ta_tenable_sc_inputs") > -1 && "security center".indexOf(rawSearch) > -1) {
...
//                         var textA = a.id.indexOf("ta_tenable_sc_inputs") > -1 ? "security center" : "nessus";
//                             textB = b.id.indexOf("ta_tenable_sc_inputs") > -1 ? "security center" : "nessus";
//                         if (sort_dir === 'asc') {
//                             return (textA < textB) ? -1 : (textA > textB) ? 1 : 0;
//                         }
//                         return (textA > textB) ? -1 : (textA < textB) ? 1 : 0;
