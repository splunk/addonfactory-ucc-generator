export default {
    ...
    103: 'Are you sure you want to delete "{{args[0]}}" {{args[1]}}? Ensure that no input is configred with account "{{args[0]}}" as this will stop data collection for that input.',
    // Error dialog title
    104: 'Error Message',
