...
@patch(
    "splunk_add_on_ucc_framework.generators.html_files.HTMLGenerator._set_attributes",
...
@patch("splunk_add_on_ucc_framework.generators.html_files.HTMLGenerator.generate_html")
...
def test__set_attributes_custom_error(
    ...
    is raised from `HTMLGenerator` class only
    """
