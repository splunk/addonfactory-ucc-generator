...
def test_generate_conf(mock_op_path, mock_template, global_config, input_dir, output_dir,ucc_dir,ta_name):
    ...
    restmap_conf = RestMapConf(global_config, input_dir, output_dir, ucc_dir=ucc_dir, addon_name=ta_name)
...
def test_generate_conf_no_gc_schema(mock_set_attribute,global_config, input_dir, output_dir,ucc_dir,ta_name):
    restmap_conf = RestMapConf(global_config, input_dir, output_dir, ucc_dir=ucc_dir, addon_name=ta_name)
