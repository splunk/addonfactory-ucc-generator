...
@patch("splunk_add_on_ucc_framework.generators.conf_files.create_app_conf.time", return_value=1234)
def test_set_attributes_no_global_config_or_schema(mock_time,global_config, input_dir, output_dir,ucc_dir,ta_name,addon_version,has_ui,app_manifest):
    """Test _set_attributes when both _global_config and _gc_schema are None."""
    app_conf = AppConf(global_config, input_dir, output_dir,ucc_dir = ucc_dir, addon_name=ta_name,addon_version=addon_version, has_ui=has_ui,app_manifest = app_manifest)
    app_conf._global_config = None
    app_conf._gc_schema = None

    app_conf._set_attributes(addon_version=addon_version,
        has_ui=has_ui,
    ...
    return app_conf.build == 1234

def test_set_attributes_check_for_updates_false(global_config, input_dir, output_dir,ucc_dir,ta_name,addon_version,has_ui,app_manifest):
...
def test_set_attributes_supported_themes(global_config, input_dir, output_dir,ucc_dir,ta_name,addon_version,has_ui,app_manifest):
...
def test_set_attributes_with_global_config_and_schema(global_config, input_dir, output_dir,ucc_dir,ta_name,addon_version,has_ui,app_manifest):
...
@patch(
    "splunk_add_on_ucc_framework.generators.conf_files.AppConf.get_file_output_path"
)
def test_generate_conf(mock_op_path, mock_template,global_config, input_dir, output_dir,ucc_dir,ta_name,addon_version,has_ui,app_manifest):
    content = "content"
    exp_fname = "app.conf"
