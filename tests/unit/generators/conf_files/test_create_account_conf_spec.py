...
def test_set_attributes(global_config, input_dir, output_dir,ucc_dir,ta_name):
        ...
        account_spec = AccountConf(global_config, input_dir, output_dir,ucc_dir = ucc_dir, addon_name=ta_name)
...
def test_set_attributes_gc_schema_only(global_config, input_dir, output_dir,ucc_dir,ta_name):
...
def test_set_attributes_with_oauth_account(global_config, input_dir, output_dir,ucc_dir,ta_name):
...
@patch("splunk_add_on_ucc_framework.generators.conf_files.AccountConf.set_template_and_render")
@patch("splunk_add_on_ucc_framework.generators.conf_files.AccountConf.get_file_output_path")
def test_generate_conf_spec(mock_op_path, mock_template, global_config, input_dir, output_dir,ucc_dir,ta_name):
    ...
    # Create a AccountConf instance
    account_spec = AccountConf(global_config, input_dir, output_dir, ucc_dir = ucc_dir, addon_name=ta_name)
    account_spec.writer = MagicMock()
    account_spec._template = mock_template_render
    # account_spec.default_content = "default_content"
...
def test_generate_conf_no_gc_schema(global_config, input_dir, output_dir,ucc_dir,ta_name):
    account_spec = AccountConf(global_config, input_dir, output_dir, ucc_dir=ucc_dir, addon_name=ta_name)

    # Mock the _gc_schema attribute that contains the endpoints
