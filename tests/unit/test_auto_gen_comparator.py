...
def test_deduce_common_conf_file(tmp_path, caplog):
    src_dir = tmp_path / "src"
    dst_dir = tmp_path / "dst"

    # Identical .conf file in both
    src_conf_file = src_dir / "default" / "app.conf"
    dst_conf_file = dst_dir / "default" / "app.conf"
    ...
    comparator.deduce_gen_and_custom_content(build.logger)
...
def test_deduce_different_conf_file(tmp_path):
    src_dir = tmp_path / "src"
    dst_dir = tmp_path / "dst"

    # Different .conf files in src and dst
    src_file = src_dir / "default" / "app.conf"
    dst_file = dst_dir / "default" / "restmap.conf"
...
def test_deduce_different_content_in_conf_file(tmp_path, caplog):
    src_dir = tmp_path / "src"
    dst_dir = tmp_path / "dst"
    ...
    # Identical .conf file in both
    src_file = src_dir / "default" / "app.conf"
    dst_file = dst_dir / "default" / "app.conf"
    create_file(dst_file, CONF_FILE_CONTENT)
    ...
    # TODO: uncomment the declaration when UCC allows to merge .conf files
    ...
    # TODO: uncomment the assertions when UCC allows to merge .conf files
