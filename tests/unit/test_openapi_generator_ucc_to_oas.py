...
class TestUccToOas:
    ...
    def test_ucc_to_oas(self):
        ...
        app_manifest = ucc_object.AppManifest(json_path=Path(app_manifest_file))
        oas = transform(ucc_project_path=None, global_config=valid_config,app_manifest=app_manifest)
