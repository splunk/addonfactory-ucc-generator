...
def test_install_libraries_when_no_splunktaucclib_is_present_but_has_ui(tmp_path):
    ...
    expected_msg = (
        ...
        f"Please add it there and make sure it is at least version 6.5.0."
    )
...
def test_install_libraries_when_wrong_splunktaucclib_is_present_but_has_ui(tmp_path):
    ...
    expected_msg = "splunktaucclib found but has the wrong version. Please make sure it is at least version 6.5.0."
