import{j as a}from"./jsx-runtime-ClejQJRV.js";import{r as u}from"./index-BnZYiL63.js";import{a as O,C}from"./modes-torNl340.js";import{B as j}from"./Button-BHr02HYf.js";import{q as m,V as $}from"./Clickable-wzamu0qE.js";import{C as D}from"./CollapsiblePanel-BPnrRfFA.js";import{v as c}from"./variables-BlEdyhR1.js";import{p as g}from"./pick-BPsdbB5n.js";import{S}from"./Switch-CnzSxpRR.js";function A(e){return"label"in e}function G({groups:e,rows:n}){const t=new Map;return n.reduce((r,o)=>{const l=e?.find(d=>d.fields.includes(o.field));if(!l)return r.push(o),r;let s=t.get(l.label);return s?s.rows.push(o):(s={...l,rows:[o]},t.set(l.label,s),r.push(s)),r},[])}function T(e,n){const t=new Map(e),r="allRows"in n&&n.allRows||"groupFields"in n&&n.groupFields||"field"in n&&[n.field]||[];let o=!1;return r.forEach(l=>{e.get(l)?.checkbox!==n.checkbox&&(o=!0,t.set(l,{checkbox:n.checkbox}))}),o?t:e}function N(e,n){let t=0;return e.rows.forEach(r=>{n.get(r.field)?.checkbox&&(t+=1)}),t}function I(e){const n=new Map;return e.forEach(t=>{const r=t.checkbox?.defaultValue;typeof r=="boolean"&&n.set(t.field,{checkbox:r})}),n}const V=$`
    align-self: center;
