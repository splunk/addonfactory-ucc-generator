...
> Forked from the [Airbnb style guide](https://github.com/airbnb/javascript). See [Differences from Airbnb](#differences-from-airbnb) below.
...
## Table of Contents
  ...
  1. [Testing](#testing)
  1. [Logging](#logging)
  1. [Differences from Airbnb](#differences-from-airbnb)
...
## Logging
  ...
  - Don't access the global `console` object for logging, go through the `util/console` module instead.
...
## Differences from Airbnb
  ...
  - A newline character is not required at the end of each file.
  - Custom rules for logging statements see [Logging](#logging) above
