package com.splunk.particles.initializers
{
	...
	public class VelocityInitializer implements IInitializer
	{
		...
		public function VelocityInitializer(distribution:IDistribution2D = null)
		{
		...
		public function apply(particle:IParticle) : void
		{
			...
			particle2D.velocity = distribution.getRandomPoint();
		}
