package com.jasongatt.layout
{
	...
	public class DistributedStackLayout extends LayoutSprite
	{
		...
		private var _layoutPolicy:DistributedStackLayoutPolicy;

		// Constructor

		public function DistributedStackLayout()
		{
			this._orientation = new ObservableProperty(this, "orientation", String, Orientation.Y, this.invalidates(LayoutSprite.MEASURE));

			this._layoutPolicy = new DistributedStackLayoutPolicy();
		}
