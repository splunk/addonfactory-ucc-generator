define(function() {
    ...
    return {
        BASIC_MOCK_RESULTS_ROW: BASIC_MOCK_RESULTS_ROW,
        MUTLIVALUE_MOCK_RESULTS_ROW: MUTLIVALUE_MOCK_RESULTS_ROW,
        SINGLE_CELL_MUTLIVALUE_MOCK_RESULTS_ROW: SINGLE_CELL_MUTLIVALUE_MOCK_RESULTS_ROW,
        TIME_SERIES_MOCK_RESULTS_ROW: TIME_SERIES_MOCK_RESULTS_ROW,
        TIME_SERIES_WITH_MILLIS_MOCK_RESULTS_ROW: TIME_SERIES_WITH_MILLIS_MOCK_RESULTS_ROW,
        MATCH_TABLE_RESULTS: MATCH_TABLE_RESULTS,
        MATCH_TABLE_RESULTS_WITH_OFFSET: MATCH_TABLE_RESULTS_WITH_OFFSET,
        MATCH_TABLE_RESULTS_WITH_OFFSET_AND_REQUIRED_TEXT: MATCH_TABLE_RESULTS_WITH_OFFSET_AND_REQUIRED_TEXT
    };
});