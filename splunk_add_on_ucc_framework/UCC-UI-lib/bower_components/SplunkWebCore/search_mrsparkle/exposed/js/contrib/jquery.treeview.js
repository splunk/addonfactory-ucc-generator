	...
	$.extend($.fn, {
		...
		heightToggle: function(animated, callback) {
			animated ?
				...
				this.each(function(){
					jQuery(this)[ jQuery(this).parent().hasClass(CLASSES.collapsable) ? "show" : "hide" ]();
					if(callback)
		...
		applyClasses: function(settings, toggler) {
			...
			if (!settings.prerendered) {
				...
				this.filter(":has(>ul:hidden)").not('.'+CLASSES.open).not('.'+CLASSES.leaf)
