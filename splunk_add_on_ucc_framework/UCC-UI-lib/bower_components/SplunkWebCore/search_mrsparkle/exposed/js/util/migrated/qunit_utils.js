...
define([
    ...
    var bbDeepEqual = function bbDeepEqual(expected, actual, message) {
        ...
        assert.deepEqual(replaceWithCids(expected), replaceWithCids(actual), message);
    };
    ...
    var FakeXhrModule = {
        ...
        verifyRequestArgs: function(request, expected, message) {
            ...
            assert.deepEqual(argsAsObject, expectedCopy, message);
        },
    ...
    var partialEq = function(result, expectedSubset, msg) {
        ...
        assert.deepEqual(result && _.pick(result, _.keys(expectedSubset)) || result, expectedSubset, msg);
    };
