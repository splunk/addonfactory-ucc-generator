    ...
    function(
        ...
        return {
            ...
            testCreateNewArchive: function(controllerModel){
                ...
                equal(createArchiveClicked, true, "New Archive Button clicked");
            },
            ...
            testCreateArchive: function(archiveName, values, view, model){
                ...
                if (model.set({}, {validate:true})) {
                    equal(name, archiveName, "New archive (" + archiveName + ") created.");
                }
                else {
                    ok(!name, "New archive not created. Name is required.");
                }
            },
