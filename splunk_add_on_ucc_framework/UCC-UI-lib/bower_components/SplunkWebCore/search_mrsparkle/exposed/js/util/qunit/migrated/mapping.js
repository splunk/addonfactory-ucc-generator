...
define([
    ...
    var Module = {
        ...
        verifyLegendLabels: function(legendContainer, expectedRanges) {
            ...
            assert.equal($legendLabelElements.length, expectedRanges.length, 'the number of labels is correct');
            _(expectedRanges).each(function(expected, i) {
                ...
                if (_.isArray(expected)) {
                    ...
                    assert.deepEqual(actualLabelsAsFloats, expected, 'label ' + i + ' is correct');
                } else {
                    assert.equal(actual, expected.toString(), 'label ' + i + ' is correct');
                }
            });
        }
