...
def resolve_entity(entity_definition: Dict[str, Any]) -> Entity:
...
def collapse_entity(entity_definition: Dict[str, Any]) -> Dict[str, Any]:
    return resolve_entity(entity_definition).short_form()
