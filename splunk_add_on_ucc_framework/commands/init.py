...
def init(
    ...
    logger.info(
        """You have generated your add-on and are wondering what to do next? \
...
Add our \"Monitoring dashboard\". - https://splunk.github.io/addonfactory-ucc-generator/dashboard/
...
https://splunk.github.io/addonfactory-ucc-generator/advanced/os-dependent_libraries/\n
    For future reference, if there is a need to improve your add-ons:
        * Need better organization in your add-on? You can use the option of dividing inputs into categories. - \
https://splunk.github.io/addonfactory-ucc-generator/inputs/multilevel_menu/
        * Would you like to modify the value of one field depending on the value of another? - \
https://splunk.github.io/addonfactory-ucc-generator/entity/modifyFieldsOnValue/
        * Would you like to create interactive endpoint documentation? Use autogenerated openapi.json file. - \
https://splunk.github.io/addonfactory-ucc-generator/openapi/
        * Does your add-on need some custom UI components? Check what support UCC offers in this topic. - \
https://splunk.github.io/addonfactory-ucc-generator/custom_ui_extensions/overview/
...
https://splunk.github.io/addonfactory-ucc-generator/
    ...
    To install this newly generated add-on on your splunk, you need to follow the next two steps in this order:
        1. Build the add-on you just generated using the \"build\" command. - \
https://splunk.github.io/addonfactory-ucc-generator/quickstart/#ucc-gen-build
        2. Pack the built add-on up using the \"package\" command so that you can install it on your own \
Splunk instance. - https://splunk.github.io/addonfactory-ucc-generator/quickstart/#ucc-gen-package
        """
    )
    return generated_addon_path
